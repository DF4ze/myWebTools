...
// 
// Version 2.1 modifié AS ligne 183
// -------------------------------------------------------

class rss_read
{
	var $class_version = '2.1';
	var $rss_channel = array();
	var $rss_image = array();
	var $rss_items = array();
	var $rss_textinput = array();
	var $rss_encoding = '';
	var $to_replace = array();
	var $replace_with = array();
	...
	*/
	...
	function exist_image() {
		return (!empty($this -> rss_image) and 
			!empty($this -> rss_image['title']) and 
			!empty($this -> rss_image['link']) and
			!empty($this -> rss_image['url']));
	}
