...
class writeexcel_olewriter {
    ...
    function _initialize() {
        ...
        if ($OLEfile == '') {
			...
			throw new Exception( "Un nom de fichier est necessaire. <br/> code erreur : ".E_USER_ERROR  );
        }
        ...
        if (is_resource($OLEfile)) {
            ...
            if (!$fh) {
				...
				throw new Exception( "Impossible d'ouvrir le fichier $OLEfile. Il est soit utilisé, soit protégé. <br/> code erreur : ".E_USER_ERROR );
            }
    ...
    function set_size($size) {
        ...
        if ($size > $maxsize) {
			...
			throw new Exception( "Taille Maximale atteinte. Le fichier ne peut dépasser $maxsize octets. <br/> code erreur : ".E_USER_ERROR );
...
/* ABR */
        if ($this->_OLEtmpfilename != '') {
            ...
            if ($fh == false) {
				...
				throw new Exception( "Impossible de lire le fichier temporaire. <br/> code erreur : ".E_USER_ERROR );
            }
            fpassthru($fh);
            fclose($fh);
