...
function listing($directory, $arg, $CONFIG, $LANGUE){
        ...
        $fp=@opendir($directory) or die($LANGUE['erreur']['Config']);
        ...
        if(file_exists('icones./'.$CONFIG['ICO_FOLDER'].'/rep_open.png'))
        ...
        if(!empty($tableau)){
                ...
                while(list(,$subdir) = each($tableau)){
                        ...
                        echo ' alt="'.$LANGUE['type']['dossier'].'" title="'.$LANGUE['type']['dossier'].'" class="ico">';
                        echo '&nbsp;'.$subdir;
                        echo " </a>";
                        echo " </td>\n";
                        echo " </tr>\n";
