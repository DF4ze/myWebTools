...
include('./showpict.inc.php');

if ($CONFIG['AUTO_RESIZE'])
	$method = 'down('.$widthImg.','.$heightImg.');';#.'down('.$widthImg.','.$heightImg.');';
	else
...
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <a href="showpict.php?<?php echo $queryNext;?>"<?php if ($CONFIG['DETAILS']) echo 'onClick="open(\'arbre.php?'.$queryNext; ?>','tree','')">
...
<table border="0" align="center">
  <tr>
    <td ><a href="showpict.php?<?php echo $queryPrevious ?>"<?php if ($CONFIG['DETAILS']) echo ' onClick="open(\'arbre.php?'.$queryPrevious ?>','tree','')"><img src="<?php echo $CONFIG['ICO_FOLDER'] ?>/precedent.gif" alt="<?php echo $LANGUE['liste']['Precedent'] ?>"  title="<?php echo $LANGUE['liste']['Precedent'] ?>"  border="0"></a></td>
    <td ><a href="showpict.php?<?php echo $queryNext ?>"<?php if ($CONFIG['DETAILS']) echo ' onClick="open(\'arbre.php?'.$queryNext ?>','tree','')"><img src="<?php echo $CONFIG['ICO_FOLDER'] ?>/suivant.gif" alt="<?php echo $LANGUE['liste']['Suivant'] ?>"   title="<?php echo $LANGUE['liste']['Suivant'] ?>"  border="0"></a></td>
    <td >&nbsp;<img border="0" src="<?php echo $CONFIG['ICO_FOLDER'] ?>/espaceur.gif">&nbsp;</td>
    <td ><a href="#" onclick="<?php echo 'up('.$widthImg.','.$heightImg.');' ?>"><img src="<?php echo $CONFIG['ICO_FOLDER'] ?>/size_up.gif" alt="<?php echo $LANGUE['liste']['Taille_reelle'] ?>" title="<?php echo $LANGUE['liste']['Taille_reelle'] ?>" border="0" ></a></td>
    <td ><a href="#" onclick="<?php echo $method ?>"><img src="<?php echo $CONFIG['ICO_FOLDER'] ?>/size_down.gif" alt="<?php echo $LANGUE['liste']['Ajuste'] ?>" title="<?php echo $LANGUE['liste']['Ajuste'] ?>" border="0" ></a></td>
    <td >&nbsp;<img border="0" src="<?php echo $CONFIG['ICO_FOLDER'] ?>/espaceur.gif">&nbsp;</td>
    <?php if($CONFIG['SLIDE_SHOW']) { ?>
    <td ><a href="#" onclick="fullwin('slideshow.php?<?php echo $query ?>')"><img src="<?php echo $CONFIG['ICO_FOLDER'] ?>/slideshow.gif" alt="<?php echo $LANGUE['liste']['Slide_Show'] ?>" title="<?php echo $LANGUE['liste']['Slide_Show'] ?>" border="0"></a></td>
    <td >&nbsp;<img border="0" src="<?php echo $CONFIG['ICO_FOLDER'] ?>/espaceur.gif">&nbsp;</td>
    <?php } ?>
    <td ><a href="showtn.php?<?php echo $queryDir ?>"><img src="<?php echo $CONFIG['ICO_FOLDER'] ?>/up.gif" alt="<?php echo $LANGUE['liste']['retour'] ?>" title="<?php echo $LANGUE['liste']['retour'] ?>" border="0"></a></td>
  </tr>
</table></td>
  </tr>
</table>
